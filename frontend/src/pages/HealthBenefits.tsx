...
const HealthBenefits = () => {
  const pageTitle = "Health Benefits of Air Duct Cleaning | Allergy & Asthma Relief Los Angeles | Pure Air California";
  const pageDescription = "Discover how professional air duct cleaning in Los Angeles can reduce allergies, ease asthma symptoms & improve indoor air quality. NADCA certified. Free estimates!";
  const pageUrl = `${seoConfig.siteUrl}/health-benefits`;
    ...
    <HelmetProvider>
      <div className="min-h-screen flex flex-col">
        <Helmet>
          ...
          <meta name="keywords" content="air duct cleaning health benefits Los Angeles, allergy relief air duct cleaning LA, asthma symptom reduction duct cleaning, indoor air quality improvement Los Angeles, respiratory health clean air ducts" />
          ...
          <meta property="og:image" content={`${seoConfig.siteUrl}/images/health/woman-breathing-clean-air.jpg`} />
        ...
        <SEOProvider>
          <SchemaMarkup schema={{
            ...
            "@type": "Article",
            "headline": "Health Benefits of Air Duct Cleaning",
            "author": {
              "@type": "Organization",
              "name": "Pure Air California"
            },
            "publisher": seoConfig.schema.organization,
            "image": `${seoConfig.siteUrl}/images/health/woman-breathing-clean-air.jpg`,
            "url": pageUrl,
            "mainEntityOfPage": {
              "@type": "WebPage",
              "@id": pageUrl
        ...
        {/* Hero Section */}
        <div className="relative py-24 bg-gradient-to-r from-[#0A3D7C] to-[#5BBDE4] overflow-hidden">
          <div className="absolute inset-0 z-0">
            <ResponsiveImage
              src="/images/hero/health-hero.jpg"
              alt="Blue sky with clouds representing clean air"
                  ...
                  <div className="flex flex-col md:flex-row gap-6">
                    <div className="md:w-1/2">
                      <ResponsiveImage
                        ...
                        alt="Happy couple enjoying clean air at home"
