...
const CongaPark = () => {
  return (
    <div className="min-h-screen flex flex-col">
      <Helmet>
        <title>Canyon Park Air Duct Cleaning | Pure Air California</title>
        <meta
          name="description"
          content="Professional air duct and dryer vent cleaning services in Canyon Park. Enhance your home's air quality with our expert solutions."
        />
      </Helmet>
      <NavBar />
      ...
      <section
        ...
        style={{
          backgroundImage: `url(https://source.unsplash.com/random?canyon-park)`,
        ...
        <div className="container mx-auto px-4 relative z-10">
          <div className="max-w-3xl">
            <h1 className="text-4xl md:text-5xl font-bold text-white leading-tight mb-6 font-heading">
              Air Duct Cleaning Services in Canyon Park
            </h1>
            <p className="text-xl text-gray-200 mb-8">
              Pure Air California offers top-notch air duct and dryer vent cleaning services in Canyon Park.
            </p>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            ...
            <div className="service-card bg-gray-50 p-6 rounded-lg shadow-md">
              ...
              <p className="text-gray-700">
                Improve the air quality in your Canyon Park home with our professional residential air duct cleaning services.
              </p>
            </div>
            ...
            <div className="service-card bg-gray-50 p-6 rounded-lg shadow-md">
             ...
             <div className="service-card bg-gray-50 p-6 rounded-lg shadow-md">
              ...
              <p className="text-gray-700">
              Keep your business healthy with our expert commercial air duct cleaning services in Canyon Park.
              </p>
            </div>
             ...
             <div className="service-card bg-gray-50 p-6 rounded-lg shadow-md">
              ...
              <p className="text-gray-700">
              Our commercial dryer vent cleaning services help businesses in Canyon Park stay safe and efficient.
              </p>
            </div>
      ...
      <section className="py-16 bg-gray-50">
        <div className="container mx-auto px-4">
          <h2 className="text-3xl md:text-4xl font-bold text-center font-heading mb-12">
            Get a Free Quote for Your Canyon Park Property
          </h2>
          <QuoteForm />
        </div>
      </section>
