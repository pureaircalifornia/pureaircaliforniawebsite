  ...
  return (
    <HelmetProvider>
      <div className="min-h-screen flex flex-col">
        <Helmet>
          <title>Commercial Air Duct Cleaning Los Angeles | Office & Retail HVAC | Pure Air California</title>
          <meta name="description" content="Professional commercial air duct cleaning in Los Angeles for offices, retail, healthcare & hospitality. NADCA certified, improve indoor air quality. Free quotes! (213) 792-4145" />
          <meta name="keywords" content="commercial air duct cleaning Los Angeles, office air duct cleaning LA, retail air duct cleaning, healthcare HVAC cleaning, business air duct cleaning Los Angeles, commercial HVAC cleaning" />
          <meta name="robots" content="index, follow, max-image-preview:large" />
          <meta name="geo.region" content="US-CA" />
          <meta name="geo.placename" content="Los Angeles" />
          <meta property="og:title" content="Commercial Air Duct Cleaning Los Angeles | Pure Air California" />
          <meta property="og:description" content="Professional commercial air duct cleaning for offices, retail, healthcare & hospitality in Los Angeles. Improve indoor air quality & reduce energy costs." />
          <meta property="og:type" content="website" />
          <meta property="og:url" content="https://www.pureaircalifornia.com/services/commercial-air-duct-cleaning" />
          <meta property="og:site_name" content="Pure Air California" />
          <link rel="canonical" href="https://www.pureaircalifornia.com/services/commercial-air-duct-cleaning" />
          <script type="application/ld+json">
            {JSON.stringify({
              ...
              "description": "Professional commercial air duct cleaning services for offices, retail, healthcare, and hospitality in Los Angeles. Improve indoor air quality, reduce energy costs, and ensure compliance.",
              "areaServed": {
                "@type": "City",
                "name": "Los Angeles",
        ...
        <section className="py-16">
          <div className="container mx-auto px-4">
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
              ...
              <div>
                <ResponsiveImage
                  src="/images/hero/commercial-duct-v2.png"
          ...
          <div className="container mx-auto px-4">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
              <TestimonialCard
                ...
                quote="Pure Air California transformed our office environment. Our employees have reported fewer allergy issues, and the air just feels fresher. Their team was professional and worked around our schedule."
                rating={5}
              />
              <TestimonialCard
                name="Maria S."
                location="Restaurant Owner, Beverly Hills"
                quote="We had a major issue with cooking odors in our dining area. Pure Air California's commercial service was a game-changer. Our customers have noticed the difference, and our kitchen staff is happier too."
                rating={5}
              />
              <TestimonialCard
                name="David L."
                location="Facility Manager, Glendale"
                quote="As a facility manager for multiple retail locations, I need a reliable partner. Pure Air California is that partner. They are professional, thorough, and their maintenance program makes my job easier."
                rating={5}
              />
            </div>
          </div>
