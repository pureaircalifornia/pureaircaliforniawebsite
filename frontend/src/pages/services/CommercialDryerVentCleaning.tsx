...
const CommercialDryerVentCleaning = () => {
  const pageTitle = "Commercial Dryer Vent Cleaning Los Angeles | Laundromat & Hotel | Pure Air California";
  const pageDescription = "Specialized dryer vent cleaning for laundromats, hotels & commercial laundry in Los Angeles. Fire prevention, efficiency, compliance. Free quotes! (213) 792-4145";
  const pageUrl = `${seoConfig.siteUrl}/services/commercial-dryer-vent-cleaning`;

  const faqs = [
    {
      question: "How often should commercial dryer vents be cleaned?",
      answer: "For most commercial applications, we recommend cleaning every 6-12 months. High-volume facilities like laundromats may require quarterly cleaning. We can help you determine the appropriate schedule for your business."
    },
    {
      question: "How long does the service take?",
      answer: "The duration depends on the number of dryers and the complexity of the vent system. A typical service can take 2-4 hours, but we will provide a more accurate time estimate during our initial assessment."
    },
    {
      question: "Can you service our business after hours?",
      answer: "Yes, we offer flexible scheduling, including after-hours and weekend appointments, to minimize disruption to your business operations."
    }
  ];
    ...
    <HelmetProvider>
      <div className="min-h-screen flex flex-col">
        <Helmet>
          ...
          <meta name="keywords" content="commercial dryer vent cleaning Los Angeles, laundromat dryer vent cleaning LA, hotel dryer vent cleaning, business dryer vent maintenance Los Angeles" />
        ...
        <section className="pt-32 pb-16 bg-gradient-to-r from-brand-700 to-brand-900 text-white">
          <div className="container mx-auto px-4">
            <div className="max-w-3xl">
              <h1 className="text-4xl md:text-5xl font-bold mb-6 text-white" style={{ textShadow: '0 0 20px rgba(255,255,255,0.3), 0 0 40px rgba(100,180,255,0.2), 0 0 60px rgba(100,180,255,0.1)' }}>Commercial Dryer Vent Cleaning</h1>
        ...
        <section className="py-16">
          <div className="container mx-auto px-4">
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
              ...
              <div>
                <ResponsiveImage
                  src="/images/hero/commercial-dryer-vent-Main.jpg"
        ...
        <section className="py-16">
          <div className="container mx-auto px-4">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
              <TestimonialCard
                name="John D."
                location="Laundromat Owner, Los Angeles"
                quote="Pure Air California's quarterly maintenance program has been a lifesaver. Our dryers run more efficiently, and I have peace of mind knowing we're preventing fire hazards. Their team is always professional and reliable."
                rating={5}
              />
              <TestimonialCard
                name="Maria S."
                location="Hotel Manager, Anaheim"
                quote="We use Pure Air California for all our hotel's dryer vents. They work around our schedule to avoid disrupting guests, and their service has significantly reduced our energy bills. Highly recommended for any hospitality business."
                rating={5}
              />
              <TestimonialCard
                name="David L."
                location="Property Manager, Irvine"
                quote="I manage a large apartment complex, and Pure Air California handles all our dryer vent cleaning needs. They are professional, efficient, and provide detailed reports for our records. A top-notch service."
                rating={5}
              />
            </div>
          </div>
