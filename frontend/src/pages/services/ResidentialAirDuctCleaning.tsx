    ...
    <HelmetProvider>
      <div className="min-h-screen flex flex-col">
        <Helmet>
          ...
          <meta name="keywords" content="residential air duct cleaning Los Angeles, home air duct cleaning LA, air duct cleaning service near me, HVAC cleaning Los Angeles, indoor air quality home, duct cleaning for allergies" />
        ...
        <section className="pt-32 pb-16 bg-gradient-to-r from-brand-700 to-brand-900 text-white">
          <div className="container mx-auto px-4">
            <div className="max-w-3xl">
              <h1 className="text-4xl md:text-5xl font-bold mb-6" style={{ textShadow: '0 0 20px rgba(255,255,255,0.3), 0 0 40px rgba(100,180,255,0.2), 0 0 60px rgba(100,180,255,0.1)' }}>Residential Air Duct Cleaning</h1>
