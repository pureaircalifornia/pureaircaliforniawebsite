...
import { Filter, Check, Building, ArrowRight, Shield, Award, Clock, Zap, Users, Home } from 'lucide-react';
...
const ResidentialElectrostaticFilter = () => {
  const faqs = [
    {
      question: "How do electrostatic filters compare to HEPA filters?",
      answer: "Electrostatic filters offer similar filtration efficiency to HEPA filters but are more cost-effective long-term. They're washable and reusable, eliminating ongoing replacement costs while providing excellent particle capture."
    },
    {
      question: "How often do I need to clean my electrostatic filter?",
      answer: "Most homeowners should clean their electrostatic filter every 1-3 months. If you have pets, allergies, or live in a dusty environment, more frequent cleaning may be necessary."
    },
    {
      question: "Can electrostatic filters help with allergies?",
      answer: "Yes! Electrostatic filters are excellent for allergy sufferers. They capture pollen, pet dander, dust mites, and other common allergens, significantly reducing their presence in your home's air."
    }
  ];
  return (
    <HelmetProvider>
      <div className="min-h-screen flex flex-col">
        <Helmet>
          <title>Residential Electrostatic Air Filters Los Angeles | Washable | Pure Air California</title>
          <meta name="description" content="Upgrade to electrostatic air filters in Los Angeles. Washable, reusable & superior filtration for allergies. Save money & improve air quality. (213) 792-4145" />
          <meta name="keywords" content="electrostatic air filter Los Angeles, washable air filter LA, residential air filtration, allergy relief Los Angeles, permanent air filter" />
          <meta name="robots" content="index, follow, max-image-preview:large" />
          <meta name="geo.region" content="US-CA" />
          <meta name="geo.placename" content="Los Angeles" />
          <meta property="og:title" content="Residential Electrostatic Air Filters Los Angeles | Pure Air California" />
          <meta property="og:description" content="Upgrade your home's air filtration with advanced electrostatic air filters in Los Angeles. Superior filtration, washable filters, improved air quality." />
          <meta property="og:type" content="website" />
          <meta property="og:url" content="https://www.pureaircalifornia.com/services/residential-electrostatic-filter" />
          <meta property="og:site_name" content="Pure Air California" />
          <link rel="canonical" href="https://www.pureaircalifornia.com/services/residential-electrostatic-filter" />
          <script type="application/ld+json">
            {JSON.stringify({
              ...
              "description": "Upgrade your home's air filtration with advanced electrostatic air filters in Los Angeles. Superior filtration, washable filters, improved air quality.",
              "areaServed": {
                "@type": "City",
                "name": "Los Angeles"
              }
        ...
        <section className="py-16">
          <div className="container mx-auto px-4">
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
              ...
              <div>
                <ResponsiveImage
                  src="/images/services/residential-electrostatic-filter-installation.jpg"
          ...
          <div className="container mx-auto px-4">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
              <TestimonialCard
                ...
                quote="The electrostatic filter has made a huge difference in our home. My son's allergies are much better, and the air just feels cleaner. Plus, I love that I can just wash and reuse the filter."
                rating={5}
              />
              <TestimonialCard
                name="Mark R."
                location="Pasadena, CA"
                quote="I was tired of buying new filters every few months. The electrostatic filter is a great investment. The installation was quick and professional, and I'm already saving money."
                rating={5}
              />
              <TestimonialCard
                name="Emily T."
                location="Santa Monica, CA"
                quote="I have two dogs, and the electrostatic filter has been amazing for reducing pet dander and odors. I can't believe how much it captures. A must-have for any pet owner."
                rating={5}
              />
            </div>
          </div>
